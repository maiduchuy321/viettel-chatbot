...
DB_Chroma_PATH ='"C:/Users/maidu/viettel_chroma_db"'
# Set LangSmith environment variables
os.environ["LANGCHAIN_TRACING_V2"] = "true"
os.environ["LANGCHAIN_ENDPOINT"] = "https://api.smith.langchain.com"
os.environ["LANGCHAIN_PROJECT"] = "viettel"
os.environ["LANGCHAIN_API_KEY"] = "ls__2a1575776dde415382ce0317c3432eed"
...
# load from disk
db = Chroma(persist_directory="./vectorstores/viettel_chroma_db", embedding_function=embeddings)
...
if 'generated' not in st.session_state:
    st.session_state['generated'] = ["Hello ! Hãy hỏi tôi về Viettel 🤗"]
