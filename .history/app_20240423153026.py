...
#Set weaviate vector storage database
# WCS_DEMO_URL = os.getenv("WCS_DEMO_URL")
# print(WCS_DEMO_URL)
# WCS_DEMO_RO_KEY = os.getenv("WCS_DEMO_RO_KEY")
# print(WCS_DEMO_RO_KEY)
# weaviate_client = weaviate.connect_to_wcs(
#     cluster_url=WCS_DEMO_URL,  # Replace with your WCS URL
#     auth_credentials=weaviate.auth.AuthApiKey(WCS_DEMO_RO_KEY),  # Replace with your WCS key
...
# retriever.get_relevant_documents(query)[0:3]
